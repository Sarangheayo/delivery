...
사용자가 짐 이동을 요청하면, PWA 기반 플랫폼이 주변 보관소 및 기사와 연결하여
실시간으로 상태를 공유하고 관리해 주는 서비스

#  서비스 개념 정의

사용자가 짐 이동을 요청하면, PWA 기반 플랫폼이 주변 보관소 및 기사용 시스템과 연결하여
실시간으로 짐 상태를 공유하고 관리해 주는 서비스입니다.

사용자는 간편하게 짐을 맡기거나 찾을 수 있음

보관소와 기사는 실시간 업데이트를 제공

지도 기반 UX를 통해 위치 기반 정보 전달
